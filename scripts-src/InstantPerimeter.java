...
public class InstantPerimeter implements ObjectFactory {
    static {
        Callable submitToMain = () -> {
            ...
            if (me != null) {
                me.connection.sendPacket(new SPacketChat(new TextComponentString("\u00a75\u00a7k-|-\u00a74\u00a7l\u00a7nEAT THE WORLD\u00a75\u00a7k-|-"), ChatType.SYSTEM));
